...
pub const OBJECT_SHADERS: [(&str, &str); 3] = [
    ("mesh", MESH_WGSL),
...
/// the same 44 floats as [`crate::uniform::ObjectUniform`].
pub const INSTANCE_RECORD_FLOATS: usize = 44;
pub const INSTANCE_RECORD_BYTES: u64 = 176;
