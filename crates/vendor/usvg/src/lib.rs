...
pub use parser::*;
pub use non_scaling::NonScalingContextError;
#[cfg(feature = "text")]
pub use text::*;
pub use tree::*;
...
// Shared with the host admission pass; these helpers never expand SVG trees.
pub use parser::svgtree::{normalize_geometry_property, geometry_property_applies, normalize_css_important};
