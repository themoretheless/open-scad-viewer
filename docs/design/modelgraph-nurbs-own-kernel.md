...
Готовый пример [корпуса с глухим карманом](../../examples/brep/stepped-enclosure.modelgraph.scad) доступен также в галерее приложения как «B-rep: корпус с карманом». Он использует круговое основание, приподнятый боковой выступ и карман с дном 2 мм. Проверенный нативный объём — около 7619,809938 мм³; показанные в сцене метрики считаются по производной сетке и зависят от детализации.
