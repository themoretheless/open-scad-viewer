...
cargo run --release --manifest-path crates/Cargo.toml -p sdf-core --features cuda --example sdf_bench_gpu
cargo run --manifest-path crates/Cargo.toml -p sdf-core --features cuda --example sdf_backend_report
cargo run --manifest-path crates/Cargo.toml -p geometry-bridge --features gpu --example geometry_backend_report
cargo run --manifest-path crates/Cargo.toml -p photogrammetry-core --features cuda --example photogrammetry_backend_report
