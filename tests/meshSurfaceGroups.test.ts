...
import {inferSurfaceIds,withSelectionSurfaces} from '../src/services/meshSurfaceGroups'
...
it('does not cross cube creases or join disconnected coplanar triangles',async()=>{
 ...
 expect(Array.from(inferSurfaceIds(vertices,new Uint32Array([0,1,2,3,4,5])))).toEqual([0,1])
})
