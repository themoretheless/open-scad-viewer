...
export function fitLatticeToPrint(o:LighteningOptions,p:LatticePrintSettings,limitOpening=false):LighteningOptions{
 return callGeometryRust('cad_lattice_print_fit',{options:o,settings:p,limitOpening})
}
