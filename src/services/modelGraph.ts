...
const node = z.discriminatedUnion('op', [
  ...
  z.object({id,op:z.literal('gear'),teeth:scalar,module:scalar,pressure_angle:scalar.default(20),thickness:scalar,bore:scalar.default(0),backlash:scalar.default(0.15),clearance:scalar.default(0.5),internal:z.boolean().default(false),rim_width:scalar.default(6),flank_segments:scalar.default(6),helix_angle:scalar.default(0),herringbone:z.boolean().default(false)}).strict(),
  ...
  z.object({id,op:z.literal('planetary_gears'),sun_teeth:scalar,planet_teeth:scalar,planet_count:scalar,module:scalar,pressure_angle:scalar.default(20),thickness:scalar,bore:scalar.default(0),backlash:scalar.default(0.15),clearance:scalar.default(0.5),rim_width:scalar.default(6),flank_segments:scalar.default(6),carrier_angle:scalar.default(0),helix_angle:scalar.default(0),herringbone:z.boolean().default(false)}).strict(),
