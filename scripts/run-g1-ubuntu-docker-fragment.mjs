...
const PLAN = resolve(repositoryRoot, 'docs/qualification/semantic-manifold-g1-plan-v37.json')
const RESULT = resolve(repositoryRoot, 'output/qualification/semantic-manifold-g1-candidate-run-v37/result.json')
const FRAGMENTS = resolve(repositoryRoot, 'output/qualification/semantic-manifold-g1-candidate-run-v37/fragments.jsonl')
...
export QUALIFICATION_PLAN_ID=semantic-manifold-g1-plan-v37
export CI=1
${harness}
`
