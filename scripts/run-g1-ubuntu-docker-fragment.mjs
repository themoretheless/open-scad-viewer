...
const PLAN = resolve(repositoryRoot, 'docs/qualification/semantic-manifold-g1-plan-v38.json')
const RESULT = resolve(repositoryRoot, 'output/qualification/semantic-manifold-g1-candidate-run-v38/result.json')
const FRAGMENTS = resolve(repositoryRoot, 'output/qualification/semantic-manifold-g1-candidate-run-v38/fragments.jsonl')
...
export QUALIFICATION_PLAN_ID=semantic-manifold-g1-plan-v38
export CI=1
${harness}
`
