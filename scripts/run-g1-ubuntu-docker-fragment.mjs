...
const PLAN = resolve(repositoryRoot, 'docs/qualification/semantic-manifold-g1-plan-v36.json')
const RESULT = resolve(repositoryRoot, 'output/qualification/semantic-manifold-g1-candidate-run-v36/result.json')
const FRAGMENTS = resolve(repositoryRoot, 'output/qualification/semantic-manifold-g1-candidate-run-v36/fragments.jsonl')
...
export QUALIFICATION_PLAN_ID=semantic-manifold-g1-plan-v36
export CI=1
${harness}
`
