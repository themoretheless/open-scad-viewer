#!/usr/bin/env node
/**
 * Execute one G1 v20 clean-run fragment and append evidence.
 *
...
const PLAN_REL = 'docs/qualification/semantic-manifold-g1-plan-v20.json'
const RESULT_REL = 'output/qualification/semantic-manifold-g1-candidate-run-v20/result.json'
const FRAGMENTS_REL = 'output/qualification/semantic-manifold-g1-candidate-run-v20/fragments.jsonl'
...
function sanitizeEnv(seed) {
  const base = {
    ...
    QUALIFICATION_PLAN_ID: 'semantic-manifold-g1-plan-v20',
  }
