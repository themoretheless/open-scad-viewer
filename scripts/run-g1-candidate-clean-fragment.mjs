#!/usr/bin/env node
/**
 * Execute one G1 v18 clean-run fragment and append evidence.
 *
...
const PLAN_REL = 'docs/qualification/semantic-manifold-g1-plan-v18.json'
const RESULT_REL = 'output/qualification/semantic-manifold-g1-candidate-run-v18/result.json'
const FRAGMENTS_REL = 'output/qualification/semantic-manifold-g1-candidate-run-v18/fragments.jsonl'
