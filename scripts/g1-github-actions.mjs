...
const PLAN_PATH = 'docs/qualification/semantic-manifold-g1-plan-v36.json'
...
const PLAN_ID = 'semantic-manifold-g1-plan-v36'
const CANDIDATE_ID = 'semantic-manifold-g1-candidate-run-v36'
