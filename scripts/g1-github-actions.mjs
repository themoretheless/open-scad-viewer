...
const PLAN_PATH = 'docs/qualification/semantic-manifold-g1-plan-v40.json'
...
const PLAN_ID = 'semantic-manifold-g1-plan-v40'
const CANDIDATE_ID = 'semantic-manifold-g1-candidate-run-v40'
