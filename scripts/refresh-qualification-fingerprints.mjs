...
export const REFRESH_REVIEW = 'docs/qualification/g0-v20-g1-v37-refreeze-review.md'
const OWN_RUST_EVIDENCE = 'docs/qualification/own-rust-cad-v12.json'
...
export const REFRESH_OUTPUTS = Object.freeze({
  fingerprint: 'docs/qualification/g0-toolchain-fingerprints-v20.json',
  plan: 'docs/qualification/semantic-manifold-g1-plan-v37.json',
  status: 'docs/qualification/g0-v20-g1-v37-refreeze-status-v1.json',
})
const oldFingerprint = 'docs/qualification/g0-toolchain-fingerprints-v19.json'
const oldPlan = 'docs/qualification/semantic-manifold-g1-plan-v36.json'
const oldStatus = 'docs/qualification/g0-v19-g1-v36-refreeze-status-v1.json'
const oldReview = 'docs/qualification/g0-v19-g1-v36-refreeze-review.md'
...
export const FROZEN_ARCHIVES = Object.freeze({
  ...
  [oldFingerprint]: 'b928af58435dfeada9a68de5c65e07f8d25c43c9af622e2b6c80b6db141419b5',
  ...
  [oldStatus]: 'f340f0c350dd5facae5e898a36806f272e7dc877b3517461b6f30f3d52a92f25',
  ...
  [oldReview]: 'd72a0ca39c17fdf7daa62d655cd4944ab32cc8229c205edc869cfb747f1b8de2',
...
function assertNoCandidateResults(root) {
  assertCandidateResultsAbsent(root, 'semantic-manifold-g1-candidate-run-v37')
}
...
export function prepareQualificationRefresh({
  ...
  fingerprint.fingerprintId = 'g0-toolchain-fingerprints-v20'
  ...
  fingerprint.claimBoundary.excludes = [
    ...
    'Any rewrite of G0 v1-v19 or G1 v1 through v36',
  ...
  fingerprint.claimBoundary.includes = [
    ...new Set([
      ...
      'Exact SHA-256 of the V37 GitHub workflow, evidence harness, selectors, and hosted-runner identity freeze',
    ]),
  ]
  ...
  const geometryArtifacts = [
    { id: 'own-rust-cad-v12-evidence', path: OWN_RUST_EVIDENCE },
  ...
  fingerprint.knownDrift = previousFingerprint.artifacts
    ...
    .map(item => ({ relativeTo: oldFingerprint, bindingId: item.id,
      note: `Current bytes are newly bound in v20; v19 remains archived. ${reason.trim()}` }))

  const plan = structuredClone(previousPlan)
  plan.planId = 'semantic-manifold-g1-plan-v37'
  plan.processAmendment = {
    ...
    changes: [
      ...
      'Start semantic-manifold-g1-candidate-run-v37 with zero completed clean runs and zero completed work units; no prior result is imported.',
      'Retain G0 v1-v19 and G1 v1 through v36 byte-for-byte; G0 toolchain fingerprints advance separately to v20.',
    ],
    preserved: [
  ...
  plan.executionProtocol.candidateRunId = 'semantic-manifold-g1-candidate-run-v37'
  plan.executionProtocol.resultPath = 'output/qualification/semantic-manifold-g1-candidate-run-v37/result.json'
  plan.executionProtocol.cleanRunDefinition[0] = previousPlan.executionProtocol.cleanRunDefinition[0]
    .replace('exact v36 frozen artifact', 'exact v37 frozen artifact')
  ...
  const status = {
    ...
    statusId: 'g0-v20-g1-v37-refreeze-status-v1', recordedAt, reason: reason.trim(),
    ...
    executionNotes: [
      ...
      'The workflow, GitHub harness, and two fragment helpers select v37 and are frozen inputs; no v36 fragment is imported.',
