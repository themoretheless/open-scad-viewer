...
export const REFRESH_REVIEW = 'docs/qualification/g0-v23-g1-v40-refreeze-review.md'
const OWN_RUST_EVIDENCE = 'docs/qualification/own-rust-cad-v15.json'
...
export const REFRESH_OUTPUTS = Object.freeze({
  fingerprint: 'docs/qualification/g0-toolchain-fingerprints-v23.json',
  plan: 'docs/qualification/semantic-manifold-g1-plan-v40.json',
  status: 'docs/qualification/g0-v23-g1-v40-refreeze-status-v1.json',
})
const oldFingerprint = 'docs/qualification/g0-toolchain-fingerprints-v22.json'
const oldPlan = 'docs/qualification/semantic-manifold-g1-plan-v39.json'
const oldStatus = 'docs/qualification/g0-v22-g1-v39-refreeze-status-v1.json'
const oldReview = 'docs/qualification/g0-v22-g1-v39-refreeze-review.md'
...
export const FROZEN_ARCHIVES = Object.freeze({
  ...
  [oldFingerprint]: '51315ca494ad19f26fbff68c214014797accb27c0d8e08dcea37e3558222ae02',
  ...
  [oldPlan]: 'ba3df337816f03e5ed921aea2afe53862eba472b30b544d15695fc6c4ad84072',
  ...
  [oldStatus]: '6630ccfce51ee2779d13c338eea44b3c7bfdbd010c6edcb676b4d70868d31bba',
  ...
  [oldReview]: 'eb0403b718108314e1a11d113f87351deedbcfe902245fc612664da9c81d0784',
...
function assertNoCandidateResults(root) {
  assertCandidateResultsAbsent(root, 'semantic-manifold-g1-candidate-run-v40')
}
...
export function prepareQualificationRefresh({
  ...
  fingerprint.fingerprintId = 'g0-toolchain-fingerprints-v23'
  ...
  fingerprint.claimBoundary.excludes = [
    ...
    'Any rewrite of G0 v1-v22 or G1 v1 through v39',
  ...
  fingerprint.claimBoundary.includes = [
    ...new Set([
      ...
      'Exact SHA-256 of the V40 GitHub workflow, evidence harness, selectors, and hosted-runner identity freeze',
    ]),
  ]
  ...
  const geometryArtifacts = [
    { id: 'own-rust-cad-v15-evidence', path: OWN_RUST_EVIDENCE },
  ...
  fingerprint.knownDrift = previousFingerprint.artifacts
    ...
    .map(item => ({ relativeTo: oldFingerprint, bindingId: item.id,
      note: `Current bytes are newly bound in v23; v22 remains archived. ${reason.trim()}` }))

  const plan = structuredClone(previousPlan)
  plan.planId = 'semantic-manifold-g1-plan-v40'
  plan.processAmendment = {
    ...
    changes: [
      ...
      'Start semantic-manifold-g1-candidate-run-v40 with zero completed clean runs and zero completed work units; no prior result is imported.',
      'Retain G0 v1-v22 and G1 v1 through v39 byte-for-byte; G0 toolchain fingerprints advance separately to v23.',
    ],
    preserved: [
  ...
  plan.executionProtocol.candidateRunId = 'semantic-manifold-g1-candidate-run-v40'
  plan.executionProtocol.resultPath = 'output/qualification/semantic-manifold-g1-candidate-run-v40/result.json'
  plan.executionProtocol.cleanRunDefinition[0] = previousPlan.executionProtocol.cleanRunDefinition[0]
    .replace('exact v39 frozen artifact', 'exact v40 frozen artifact')
  ...
  const status = {
    ...
    statusId: 'g0-v23-g1-v40-refreeze-status-v1', recordedAt, reason: reason.trim(),
    ...
    executionNotes: [
      ...
      'The workflow, GitHub harness, and two fragment helpers select v40 and are frozen inputs; no v39 fragment is imported.',
