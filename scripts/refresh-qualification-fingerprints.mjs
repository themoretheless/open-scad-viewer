...
export const REFRESH_REVIEW = 'docs/qualification/g0-v19-g1-v36-refreeze-review.md'
const OWN_RUST_EVIDENCE = 'docs/qualification/own-rust-cad-v11.json'
...
export const REFRESH_OUTPUTS = Object.freeze({
  fingerprint: 'docs/qualification/g0-toolchain-fingerprints-v19.json',
  plan: 'docs/qualification/semantic-manifold-g1-plan-v36.json',
  status: 'docs/qualification/g0-v19-g1-v36-refreeze-status-v1.json',
})
const oldFingerprint = 'docs/qualification/g0-toolchain-fingerprints-v18.json'
const oldPlan = 'docs/qualification/semantic-manifold-g1-plan-v35.json'
const oldStatus = 'docs/qualification/g0-v18-g1-v35-refreeze-status-v1.json'
const oldReview = 'docs/qualification/g0-v18-g1-v35-refreeze-review.md'
...
export const FROZEN_ARCHIVES = Object.freeze({
  ...
  [oldFingerprint]: '2dbc8fd89e57620112638d8d57714aef555470d6d89b3b9c1ee886168ca796ab',
  ...
  [oldStatus]: '13ccd67872d2b3453f94841e0157b25fbf016bff3e97a90412b8dfbd0a1d595a',
  'docs/qualification/g0-v17-g1-v34-refreeze-review.md': '6b5d012113950b23710dc2e7e0d24944f0a742303a8383d4444d6eb391e5befc',
  [oldReview]: 'd679c5f98e0ec80b30cca43ff58651eebc9fa53a9ba475229965eeb6db1898c1',
...
function assertNoCandidateResults(root) {
  assertCandidateResultsAbsent(root, 'semantic-manifold-g1-candidate-run-v36')
}
...
export function prepareQualificationRefresh({
  ...
  fingerprint.fingerprintId = 'g0-toolchain-fingerprints-v19'
  ...
  fingerprint.claimBoundary.excludes = [
    ...
    'Any rewrite of G0 v1-v18 or G1 v1 through v35',
  ...
  fingerprint.claimBoundary.includes = [
    ...new Set([
      ...
      'Exact SHA-256 of the V36 GitHub workflow, evidence harness, selectors, and hosted-runner identity freeze',
    ]),
  ]
  ...
  const geometryArtifacts = [
    { id: 'own-rust-cad-v11-evidence', path: OWN_RUST_EVIDENCE },
  ...
  fingerprint.knownDrift = previousFingerprint.artifacts
    ...
    .map(item => ({ relativeTo: oldFingerprint, bindingId: item.id,
      note: `Current bytes are newly bound in v19; v18 remains archived. ${reason.trim()}` }))

  const plan = structuredClone(previousPlan)
  plan.planId = 'semantic-manifold-g1-plan-v36'
  plan.processAmendment = {
    ...
    changes: [
      ...
      'Start semantic-manifold-g1-candidate-run-v36 with zero completed clean runs and zero completed work units; no prior result is imported.',
      'Retain G0 v1-v18 and G1 v1 through v35 byte-for-byte; G0 toolchain fingerprints advance separately to v19.',
    ],
    preserved: [
  ...
  plan.executionProtocol.candidateRunId = 'semantic-manifold-g1-candidate-run-v36'
  plan.executionProtocol.resultPath = 'output/qualification/semantic-manifold-g1-candidate-run-v36/result.json'
  plan.executionProtocol.cleanRunDefinition[0] = previousPlan.executionProtocol.cleanRunDefinition[0]
    .replace('exact v35 frozen artifact', 'exact v36 frozen artifact')
  ...
  const status = {
    ...
    statusId: 'g0-v19-g1-v36-refreeze-status-v1', recordedAt, reason: reason.trim(),
    ...
    executionNotes: [
      ...
      'The workflow, GitHub harness, and two fragment helpers select v36 and are frozen inputs; no v35 fragment is imported.',
