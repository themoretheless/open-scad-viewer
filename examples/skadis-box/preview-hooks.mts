...
writeFileSync(new URL('hooks-preview.scad',dir),source);
...
writeFileSync(new URL('../../dist/skadis-hooks.html',import.meta.url),'<!doctype html><script>location.replace('+JSON.stringify(url)+')</script>');
